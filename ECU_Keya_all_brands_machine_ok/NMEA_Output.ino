...
Stream* NmeaOutputSerial = &Serial7; // Serial : PORT USB ou exemple : Serial8
long baudNMEA = 38400;       

// Messages NMEA à envoyer (paramétrable)
bool SEND_GPGGA = false;
bool SEND_GPVTG = false;
bool SEND_GPRMC = false;
bool SEND_GPZDA = false;
...
float GPRMC_FREQUENCY_HZ = 1.0;  // 10 Hz
...
uint32_t GPRMC_INTERVAL_MS = 1000;
